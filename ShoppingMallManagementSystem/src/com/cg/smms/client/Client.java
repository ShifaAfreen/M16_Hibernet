...
//		Customer CRUD operation
	...
	/*CustomerRepositoryImpl cri = new CustomerRepositoryImpl();
		...
		c.setId(1);
		c.setName("sam");
		c.setPhone("800000001");
		c.setEmail("sam@gamil.com");
...
//		Mall CRUD operations
		...
		Mall m =new Mall();
//		
		m.setMallName("maha-bachat-mall");
		m.setLocation("Yavatmal");
		m.setCategories("All");
...
//		Shop CRUD operations
		...
		Shop s = new Shop(); 
		s.setShopName("grocery");
		s.setShopCategory("grocery");
		s.setShopStatus("open");
		s.setLeaseStatus("done");
...
//		
		mallrepo.addMall(m);                                   //  Adding Mall with MallAdmin details
...
////		Along with Shop we are Storing shop owner too
	/*
		...
		MallRepositoryImpl mri = new MallRepositoryImpl();
		LocalDate date = LocalDate.of(2060, 10, 8);
...
//		Item details (2)
		...
		Shop shop = ssi.searchShopById(5);                            //  Getting shop for adding items
		shop.addItems(item);
		shop.addItems(item1);
...
////		Adding customer details
		...
		cust.setName("shifa");
		cust.setEmail("shifa@gmail.com");
		cust.setPhone("75555554444");
		cust.setUser(user);
		//cust.setShop(shop);
//		
		cri.beginTransaction();
